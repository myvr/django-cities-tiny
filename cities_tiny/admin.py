...
from cities_tiny.models import AdminDivision
from cities_tiny.models import City
from cities_tiny.models import Country


class CountryAdmin(admin.ModelAdmin):
    list_display = (
    'name', 'name_ascii', 'code2', 'code3', 'continent', 'geoname_id')
...
class CityAdmin(admin.ModelAdmin):
    ...
    def display_admins(self, obj):
        ...
        for admin in obj.admins.all():
            href = reverse('admin:cities_tiny_admindivision_change',
                           args=[admin.pk])
